...
<tr>
	<td class="row1 tw50pct">{L_NEW_NAME}<br /><span class="gensmall">{L_NEW_EXPLAIN}</span></td>
...
<!--
<tr>
	<td class="row1 tw50pct">{L_APPROVE_NEW_NAME}<br /><span class="gensmall">{L_APPROVE_NEW_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct">{L_EDIT_NAME}<br /><span class="gensmall">{L_EDIT_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct">{L_APPROVE_EDIT_NAME}<br /><span class="gensmall">{L_APPROVE_EDIT_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct">{L_ANON_NAME}<br /><span class="gensmall">{L_ANON_EXPLAIN}</span></td>
...
-->
<tr>
	<td class="row1 tw50pct">{L_NOTIFY_NAME}<br /><span class="gensmall">{L_NOTIFY_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct">{L_ADMIN_ID_NAME}<br /><span class="gensmall">{L_ADMIN_ID_EXPLAIN}</span></td>
	<td class="row2" width="50%"><input class="post" type="text" name="admin_id" value="{ADMIN_ID}" size="5" maxlength="4" /></td>
</tr>
<!--
<tr>
	<td class="row1 tw50pct">{L_COMMENTS}<br /><span class="gensmall">{L_COMMENTS_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct">{L_DEL_TOPIC}<br /><span class="gensmall">{L_DEL_TOPIC_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct">{L_PRE_TEXT_NAME}<br /><span class="gensmall">{L_PRE_TEXT_EXPLAIN}</span></td>
