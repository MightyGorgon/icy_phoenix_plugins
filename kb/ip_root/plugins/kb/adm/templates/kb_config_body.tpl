...
<tr>
	<td class="row1 tw50pct"><strong>{L_NEW_NAME}</strong><br /><span class="gensmall">{L_NEW_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_NOTIFY_NAME}</strong><br /><span class="gensmall">{L_NOTIFY_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_ADMIN_ID_NAME}</strong><br /><span class="gensmall">{L_ADMIN_ID_EXPLAIN}</span></td>
	<td class="row2" width="50%"><input class="post" type="text" name="admin_id" value="{ADMIN_ID}" size="5" maxlength="4" /></td>
</tr>
<tr>
	<td class="row1 tw50pct"><strong>{L_HEADER_BANNER}</strong><br /><span class="gensmall">{L_HEADER_BANNER_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_STATS_LIST}</strong><br /><span class="gensmall">{L_STATS_LIST_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_ARTICLE_PAG}</strong><br /><span class="gensmall">{L_ARTICLE_PAG_EXPLAIN}</span></td>
	<td class="row2" width="50%"><input class="post" type="text" name="art_pagination" value="{ARTICLE_PAG}" size="5" maxlength="4" /></td>
</tr>
<tr>
	<td class="row1 tw50pct"><strong>{L_COMMENTS_PAG}</strong><br /><span class="gensmall">{L_COMMENTS_PAG_EXPLAIN}</span></td>
	<td class="row2" width="50%"><input class="post" type="text" name="comments_pagination" value="{COMMENTS_PAG}" size="5" maxlength="4" /></td>
</tr>
<tr>
	<td class="row1 tw50pct"><strong>{L_NEWS_SORT}</strong></td>
	<td class="row2" width="50%">{NEWS_SORT}</td>
</tr>
<tr>
	<td class="row1 tw50pct"><strong>{L_NEWS_SORT_PAR}</strong></td>
	<td class="row2" width="50%">{NEWS_SORT_PAR} </td>
</tr>
<tr>
	<td class="row1 tw50pct"><strong>{L_WYSIWYG}</strong><br /><span class="gensmall">{L_WYSIWYG_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_WYSIWYG_PATH}</strong><br /><span class="gensmall">{L_WYSIWYG_PATH_EXPLAIN}</span></td>
	<td class="row2" width="50%"><input text="text" name="wysiwyg_path" value="{WYSIWYG_PATH}" size="20" maxlength="50" /></td>
</tr>
<tr>
	<td class="row1 tw50pct"><strong>{L_ALLOW_HTML}</strong><br /><span class="gensmall">{L_ALLOW_HTML_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_ALLOWED_HTML_TAGS}</strong><br /><span class="gensmall">{L_ALLOWED_HTML_TAGS_EXPLAIN}</span></td>
	<td class="row2" width="50%"><input text="text" name="allowed_html_tags" value="{ALLOWED_HTML_TAGS}" size="15" maxlength="50" /></td>
</tr>
<tr>
	<td class="row1 tw50pct"><strong>{L_ALLOW_BBCODE}</strong><br /><span class="gensmall">{L_ALLOW_BBCODE_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_ALLOW_SMILIES}</strong><br /><span class="gensmall">{L_ALLOW_SMILIES_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_FORMATTING_FIXUP}</strong><br /><span class="gensmall">{L_FORMATTING_FIXUP_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_USE_COMMENTS}</strong><br /><span class="gensmall">{L_USE_COMMENTS_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_COMMENTS_SHOW}</strong><br /><span class="gensmall">{L_COMMENTS_SHOW_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_BUMP_POST}</strong><br /><span class="gensmall">{L_BUMP_POST_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_DEL_TOPIC}</strong><br /><span class="gensmall">{L_DEL_TOPIC_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_USE_RATINGS}</strong><br /><span class="gensmall">{L_USE_RATINGS_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_VOTES_CHECK_IP}</strong><br /><span class="gensmall">{L_VOTES_CHECK_IP_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_VOTES_CHECK_USERID}</strong><br /><span class="gensmall">{L_VOTES_CHECK_USERID_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_PRE_TEXT_NAME}</strong><br /><span class="gensmall">{L_PRE_TEXT_EXPLAIN}</span></td>
...
<tr>
	<td class="row1 tw50pct"><strong>{L_PRE_TEXT_HEADER}</strong></td>
	<td class="row2" width="50%"><input text="text" name="pt_header" value="{L_PT_HEADER}" size="40" maxlength="100" /></td>
</tr>
<tr>
	<td class="row1 tw50pct"><strong>{L_PRE_TEXT_BODY}</strong></td>
