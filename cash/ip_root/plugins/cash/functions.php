...
{
	include(IP_ROOT_PATH . PLUGINS_PATH . $config['plugins']['cash']['dir'] . 'common.' . PHP_EXT);
	include(CASH_ROOT_PATH . 'includes/class_cash.' . PHP_EXT);
}
...
class cash_user
{
	...
	function __construct($user_id, $user_data = false)
	{
