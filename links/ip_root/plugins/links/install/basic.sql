...
INSERT INTO `phpbb_links` (`link_id`, `link_title`, `link_desc`, `link_category`, `link_url`, `link_logo_src`, `link_joined`, `link_active`, `link_hits`, `user_id`, `user_ip`, `last_user_ip`) VALUES (2, 'Luca Libralato', 'Luca Libralato', 4, 'http://www.lucalibralato.com/', 'images/links/banner_mightygorgon.gif', 1241136000, 1, 0, 2, '', '');
