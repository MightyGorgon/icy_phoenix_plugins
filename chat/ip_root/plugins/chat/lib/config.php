...
// Mighty Gorgon - Added $table_prefix - BEGIN
global $table_prefix;
$config['dbTableNames'] = array();
$config['dbTableNames']['online'] = $table_prefix . 'ajax_chat_online';
$config['dbTableNames']['messages'] = $table_prefix . 'ajax_chat_messages';
$config['dbTableNames']['bans'] = $table_prefix . 'ajax_chat_bans';
$config['dbTableNames']['invitations'] = $table_prefix . 'ajax_chat_invitations';
// Mighty Gorgon - Added $table_prefix - END
