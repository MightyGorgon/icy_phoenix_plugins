...
<tr>
	<td class="row5">
		...
		<div id="main_links_games" class="js-sh-box">
			<script type="text/javascript">
			<!--
			tmp = 'main_links';
			if(GetCookie(tmp) == '2')
...
<tr>
	<td class="row5">
		...
		<div id="games_links" class="js-sh-box">
			<script type="text/javascript">
			<!--
			tmp = 'games_links';
			if(GetCookie(tmp) == '2')
...
<tr>
	<td class="row-post-author" valign="top" width="100%">
		<div class="post-text">
			...
			<div class="post-text">
				<div style="text-align: center;">{games_on.game.NEW_I_LINK}{games_on.game.IMAGE_LINK}</a></div>
