...
<table align="center" valign="top" width="100%" class="forumline">
<tr>
	<th width="65%">&nbsp;</th>
	<th width="35%">&nbsp;</th>
</tr>
<tr>
	...
	<td class="row2 row-center" valign="middle"><span class="genmed"><input type="text" name="game_name" value="{V_ONE}" class="post" /></span></td>
</tr>
<tr>
	<td class="row2" valign="bottom"><span class="genmed">{L_TWO}</span></td>
	<td class="row2 row-center" valign="middle"><span class="genmed"><input type="text" name="game_proper" value="{V_TWO}" class="post" /></span></td>
</tr>
<tr>
	<td class="row2" valign="bottom"><span class="genmed">{L_CATEGORY}</span></td>
	<td class="row2 row-center" valign="middle">{CAT}</td></tr>
<tr>
	<td class="row2" valign="bottom"><span class="genmed">{L_THREE}</span></td>
	<td class="row2 row-center" valign="middle"><span class="genmed"><input type="text" name="game_path" value="{V_THREE}" class="post" /></span></td>
</tr>
<tr>
	<td class="row2" valign="bottom"><span class="genmed">{L_TYPE}</span></td>
	<td class="row2 row-center" valign="middle">{V_TYPE}</td>
</tr>
<tr>
	<td class="row2" valign="bottom" rowspan="2"><span class="genmed">{L_SIZE}</span></td>
	<td class="row2 row-center" valign="middle"><span class="genmed">{L_SIX}  <input type="text" name="game_width" value="{V_SIX}" size="10" class="post" /></span></td>
</tr>
<tr>
	<td class="row2 row-center" valign="middle"><span class="genmed">{L_SEVEN}  <input type="text" name="game_height" value="{V_SEVEN}" size="10" class="post" /></span></td>
</tr>
<tr>
	...
	<td class="row2 row-center" valign="middle"><span class="genmed">{L_MOUSE}&nbsp;&nbsp;<input type="checkbox" name="game_mouse" {MOUSE} /></span></td>
</tr>
<tr><td class="row2 row-center" valign="middle"><span class="genmed">{L_KEYBOARD}&nbsp;&nbsp;<input type="checkbox" name="game_keyboard" {KEYBOARD}></span></td></tr>
<tr>
	<td class="row2" valign="bottom"><span class="genmed">{L_EIGHT}</span></td>
	<td class="row2 row-center" valign="middle"><span class="genmed"><input type="text" name="game_bonus" value="{V_EIGHT}" size="10" class="post" /></span></td>
</tr>
<tr>
	<td class="row2" valign="bottom"><span class="genmed">{L_NINE}</span></td>
	<td class="row2 row-center" valign="middle"><span class="genmed"><input type="text" name="game_reward" value="{V_NINE}" size="10" class="post"></span></td>
</tr>
<tr>
	<td class="row2" valign="bottom"><span class="genmed">{L_TEN}</span></td>
	<td class="row2 row-center" valign="middle"><span class="genmed"><input type="text" name="game_charge" value="{V_TEN}" size="10" class="post" /></span></td>
</tr>
<tr>
	...
	<td class="row2 row-center" valign="middle"><span class="genmed"><input type="text" name="game_ge_cost" value="{V_GE_COST}" size="10" class="post" /></span></td>
</tr>
<tr>
	<td class="row2" valign="bottom"><span class="genmed">{L_ELEVEN}</span></td>
	<td class="row2 row-center" valign="middle"><span class="genmed"><input type="text" name="game_highscore" value="{V_ELEVEN}" size="10" class="post" /></span></td>
</tr>
<tr>
	<td class="row2" valign="bottom"><span class="genmed">{L_LINKS}</span></td>
	<td class="row2 row-center" valign="middle"><span class="genmed"><textarea rows="" cols="" class="post" name="game_links">{V_LINKS}</textarea></span></td>
</tr>
<tr>
	<td class="row2" valign="bottom"><span class="genmed">{L_FOUR}</span></td>
	<td class="row2 row-center" valign="middle"><span class="genmed"><textarea rows="" cols="" class="post" name="game_description">{V_FOUR}</textarea></span></td>
</tr>
<tr>
	<td class="row2" valign="bottom"><span class="genmed">{L_FIVE}</span></td>
	<td class="row2 row-center" valign="middle"><span class="genmed"><textarea rows="" cols="" size="" class="post" name="game_instructions">{V_FIVE}</textarea></span></td>
</tr>
<tr>
...
<tr>
	...
	<td class="row2 row-center" valign="middle"><span class="genmed"><input type="checkbox" name="reset_scores" />  {L_YES}</span></td>
</tr>
<tr>
	<td class="row2" valign="bottom"><span class="genmed">{L_RESET_JACKPOT}</span></td>
	<td class="row2 row-center" valign="middle"><span class="genmed"><input type="checkbox" name="reset_jackpot" />  {L_YES}</span></td>
</tr>
<tr>
	<td class="row2" valign="bottom"><span class="genmed">{L_DELETE_GAME}</span></td>
	<td class="row2 row-center" valign="middle"><span class="genmed"><input type="checkbox" name="delete_game" />  {L_YES}</span></td>
</tr>
<tr>
