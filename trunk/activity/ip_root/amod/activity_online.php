...
$template->set_filenames(array('activity_online_section' => ACTIVITY_MOD_PATH . 'activity_online_body.tpl'));
$expired = time() - 300;
...
$playing_members = $row['total'];
	...
	while ($row = $db->sql_fetchrow($r) )
	{
		...
		if (($playing_where == PAGE_ACTIVITY) || ($playing_where == PAGE_PLAYING_GAMES))
		{
