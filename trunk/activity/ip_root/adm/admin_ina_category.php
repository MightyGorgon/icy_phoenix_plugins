...
if( !empty($setmodules) )
{
	...
	$module['Amod+ Admin']['Category'] = "$file";
	return;
}
...
if($mode == "main" || !$mode)
	...
	if(!$assignment_check)
		{
	message_die(GENERAL_ERROR, str_replace("%L%", $link, $lang['admin_cat_21']), $lang['admin_cat_22']);
		}
	...
	$game1 = $_POST['game_assignment2'];
		...
		if(!$cat || (!$game && !$game1))
			{
		message_die(GENERAL_ERROR, $lang['admin_cat_33'] ."<a href='". $link ."'>". $lang['admin_cat_26'] .'</a>'. $lang['admin_cat_34'], $lang['admin_cat_22']);
			}
	...
	$r = $db -> sql_query($q);
		...
		message_die(GENERAL_ERROR, $lang['admin_cat_35'] ."<a href='". $link ."'>". $lang['admin_cat_26'] .'</a>'. $lang['admin_cat_27'], $lang['admin_cat_23']);
			}
	...
	$r = $db -> sql_query($q);
		...
		message_die(GENERAL_ERROR, $lang['admin_cat_36'] ."<a href='". $link ."'>". $lang['admin_cat_26'] .'</a>'. $lang['admin_cat_27'], $lang['admin_cat_23']);
			}
	...
	$r = $db -> sql_query($q);
		...
		message_die(GENERAL_ERROR, $lang['admin_cat_37'] ."<a href='". $link ."'>". $lang['admin_cat_26'] .'</a>'. $lang['admin_cat_27'], $lang['admin_cat_23']);
				}
			}
	...
	$img = $_POST['new_cat_img'];
		...
		if(!$cat || !$des)
						{
				message_die(GENERAL_ERROR, $lang['admin_cat_38'] ."<a href='". $link ."'>". $lang['admin_cat_26'] .'</a>'. $lang['admin_cat_34'], $lang['admin_cat_22']);
						}
	...
	$exists = $row['cat_name'];
		...
		if($exists)
			{
		message_die(GENERAL_ERROR, $lang['admin_cat_39'] ."<a href='". $link ."'>". $lang['admin_cat_26'] .'</a>'. $lang['admin_cat_34'], $lang['admin_cat_22']);
			}
	...
	$cat = $_POST['edit_category'];
		if(!$cat)
			{
		message_die(GENERAL_ERROR, $lang['admin_cat_41'] ."<a href='". $link ."'>". $lang['admin_cat_26'] .'</a>'. $lang['admin_cat_34'], $lang['admin_cat_22']);
			}
	...
	echo "</table>";
	echo "<br />";
	echo "<table border='0' align='center' valign='top' class='forumline'>";
	echo "	<tr>";
	echo "		<td align='center' valign='middle' width='100%' class='row2'>";
	...
	$orig = $_POST['original'];
		...
		if(!$cat || !$desc)
			{
		message_die(GENERAL_ERROR, $lang['admin_cat_45'] ."<a href='". $link ."'>". $lang['admin_cat_26'] .'</a>'. $lang['admin_cat_34'], $lang['admin_cat_22']);
			}
	...
	$exists = $row['cat_name'];
		...
		if($exists)
			{
		message_die(GENERAL_ERROR, $lang['admin_cat_46'] ."<a href='". $link ."'>". $lang['admin_cat_26'] .'</a>'. $lang['admin_cat_34'], $lang['admin_cat_22']);
			}
		}
	...
	$cat = $_POST['delete_category'];
		if(!$cat)
			{
		message_die(GENERAL_ERROR, $lang['admin_cat_48'] ."<a href='". $link ."'>". $lang['admin_cat_26'] .'</a>'. $lang['admin_cat_27'], $lang['admin_cat_22']);
			}
