...
if (!empty($setmodules))
{
	...
	$module['Amod+ Admin']['DB_Adjustments'] = "$file";
	return;
}
...
if($mode == "main" || !$mode)
	...
	$sql[] = "DELETE FROM ". CONFIG_TABLE ." WHERE config_name = 'ina_game_pass_length';";
		...
		$sql[] = "INSERT INTO ". CONFIG_TABLE ." (config_name, config_value) VALUES ('ina_daily_game_date', '". date('Y-m-d') ."');";
		...
		$sql[] = "INSERT INTO ". CONFIG_TABLE ." (config_name, config_value) VALUES ('current_ina_date','". date("Y/m/d") ."');";
