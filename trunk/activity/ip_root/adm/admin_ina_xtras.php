...
/* Deletion */
	...
	$auto_status = $board_config['ina_delete'];
...
/* Config Values */
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='max_charge' value='". $board_config['ina_default_charge'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	echo "	<tr>";
	echo "		<td align='left' valign='top' width='50%' class='row2'>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='increment' value='". $board_config['ina_default_increment'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	echo "	<tr>";
	echo "		<td align='left' valign='top' width='50%' class='row2'>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='g_path' value='". $board_config['ina_default_g_path'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	echo "	<tr>";
	echo "		<td align='left' valign='top' width='50%' class='row2'>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='reward' value='". $board_config['ina_default_g_reward'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	echo "	<tr>";
	echo "		<td align='left' valign='top' width='50%' class='row2'>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='w_height' value='". $board_config['ina_default_g_height'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	echo "	<tr>";
	echo "		<td align='left' valign='top' width='50%' class='row2'>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='w_width' value='". $board_config['ina_default_g_width'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	echo "	<tr>";
	echo "		<td align='left' valign='top' width='50%' class='row2'>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='cash_name' value='". $board_config['ina_cash_name'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	echo "	<tr>";
	echo "		<td align='left' valign='top' width='50%' class='row2'>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='use_logo' value='". $board_config['ina_use_logo'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	echo "	<tr>";
	echo "		<td align='left' valign='top' width='50%' class='row2'>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='use_jackpot' value='". $board_config['ina_jackpot_pool'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	echo "	<tr>";
	echo "		<td align='left' valign='top' width='50%' class='row2'>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='max_gamble' value='". $board_config['ina_max_gamble'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	echo "	<tr>";
	echo "		<td align='left' valign='top' width='50%' class='row2'>";
	...
	echo "		</td>";
	echo "	</tr>";
	$use_day_limit_restriction = $board_config['ina_use_max_games_per_day'];
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='max_played_count' value='". $board_config['ina_max_games_per_day'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	$post_block = $board_config['ina_post_block'];
	if($post_block == '1')
		{
	$on = "checked='checked'";
	$off = "";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='post_block_count' value='". $board_config['ina_post_block_count'] ."'>";
	echo "		</td>";
	echo "	</tr>";

	$join_block = $board_config['ina_join_block'];
	if($join_block == '1')
		{
	$on = "checked='checked'";
	$off = "";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='join_block_count' value='". $board_config['ina_join_block_count'] ."'><br />Current Setting: ". $board_config['ina_join_block_count'] ." Day(s).";
	echo "		</td>";
	echo "	</tr>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='challenge_msg' value='". $board_config['ina_challenge_msg'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	echo "	<tr>";
	echo "		<td align='left' valign='top' width='50%' class='row2'>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='challenge_m_sub' value='". $board_config['ina_challenge_sub'] ."'>";
	echo "		</td>";
	echo "	</tr>";

	$trophy_pm = $board_config['ina_pm_trophy'];
	if($trophy_pm == '1')
		{
	$on = "checked='checked'";
	$off = "";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='trophy_msg' value='". $board_config['ina_pm_trophy_msg'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	echo "	<tr>";
	echo "		<td align='left' valign='top' width='50%' class='row2'>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='trophy_m_sub' value='". $board_config['ina_pm_trophy_sub'] ."'>";
	echo "		</td>";
	echo "	</tr>";

	$show_new = $board_config['ina_use_newest'];
	if($show_new == '1')
		{
	$on = "checked='checked'";
	$off = "";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='new_game_limit' value='". $board_config['ina_new_game_count'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='new_game' value='". $board_config['ina_new_game_limit'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='new_pop' value='". $board_config['ina_pop_game_limit'] ."'>";
	echo "		</td>";
	echo "	</tr>";

	$rating_reward = $board_config['ina_use_rating_reward'];
	if($rating_reward == '1')
		{
	$on = "checked='checked'";
	$off = "";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='rating_reward_value' value='". $board_config['ina_rating_reward'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	echo "	<tr>";
	echo "		<td align='left' valign='top' width='50%' class='row2'>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='online_list_text' value='". $board_config['ina_online_list_text'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	echo "	<tr>";
	echo "		<td align='left' valign='top' width='50%' class='row2'>";
	...
	echo "		</td>";
	echo "		<td align='center' valign='top' width='50%' class='row2'>";
	echo "			<input type='text' class='post' name='online_list_color' value='". $board_config['ina_online_list_color'] ."'>";
	echo "		</td>";
	echo "	</tr>";
	$daily_game = $board_config['ina_use_daily_game'];
	if($daily_game == '1')
		{
	$on = "checked='checked'";
	$off = "";
	...
	echo "		</td>";
	echo "	</tr>";
	$random_daily = $board_config['ina_daily_game_random'];
	if($random_daily == '1')
		{
	$on = "checked='checked'";
	$off = "";
	...
	while($row = $db->sql_fetchrow($r))
		{
	if ($row['game_id'] == $board_config['ina_daily_game_id'])
		$selected = 'selected ';
	else
		$selected = '';
...
/* Toggle Values */
	...
	$guests_allowed = $board_config['ina_guest_play'];
	if($guests_allowed == '1')
		{
	$on = "checked='checked'";
	$off = "";
	...
	$show_online_list = $board_config['ina_use_online'];
	...
	echo "		</td>";
	echo "	</tr>";
	$disable_cheat = $board_config['ina_disable_cheat'];
	if($disable_cheat == '1')
		{
	$on = "checked='checked'";
	$off = "";
	...
	echo "		</td>";
	echo "	</tr>";
	$show_profile_info = $board_config['ina_show_view_profile'];
	...
	echo "		</td>";
	echo "	</tr>";
	$show_topic_info = $board_config['ina_show_view_topic'];
	...
	echo "		</td>";
	echo "	</tr>";
	$use_shoutbox = $board_config['ina_use_shoutbox'];
	if ($use_shoutbox == '1')
		{
	$on = "checked='checked'";
	$off = "";
	...
	echo "		</td>";
	echo "	</tr>";
	$disable_games = $board_config['ina_disable_everything'];
	if($disable_games == '1')
		{
	$on = "checked='checked'";
	$off = "";
	...
	echo "		</td>";
	echo "	</tr>";
	$disable_trophies_page = $board_config['ina_disable_trophy_page'];
	...
	echo "<table border='0' align='center' valign='top' width='100%'>";
	$disable_comments_page = $board_config['ina_disable_comments_page'];
	...
	echo "		</td>";
	echo "	</tr>";
	$disable_gamble_page = $board_config['ina_disable_gamble_page'];
	...
	echo "		</td>";
	echo "	</tr>";
	$disable_challenge_page = $board_config['ina_disable_challenges_page'];
	...
	echo "		</td>";
	echo "	</tr>";
	$disable_top5_page = $board_config['ina_disable_top5_page'];
	...
	echo "		</td>";
	echo "	</tr>";
	$use_trophy_king = $board_config['ina_use_trophy'];
	...
	echo "		</td>";
	echo "	</tr>";
	$disable_submit_score = $board_config['ina_disable_submit_scores_m'];
	...
	echo "		</td>";
	echo "	</tr>";
	$disable_submit_score_g = $board_config['ina_disable_submit_scores_g'];
	...
	echo "		</td>";
	echo "	</tr>";
	$force_g_register = $board_config['ina_force_registration'];
