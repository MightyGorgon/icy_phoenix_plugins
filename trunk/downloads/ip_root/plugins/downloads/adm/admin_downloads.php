...
*/
$template->set_filenames(array('body' => DL_ADM_TPL_PATH . 'downloads_main.tpl'));
...
if (sizeof($u_dl_modules) <> sizeof($l_dl_modules) || sizeof($u_dl_modules) <> sizeof($i_dl_modules))
{
...
*/
$menu_width = sizeof($u_dl_modules);
$index = array();
...
*/
$total_todo = sizeof($dl_mod->all_files(0, '', 'ASC', "AND todo <> '' AND todo IS NOT NULL"));
$total_size = $dl_mod->get_dl_overall_size();
$total_dl = $dl_mod->get_sublevel_count();
$total_extern = sizeof($dl_mod->all_files(0, '', 'ASC', "AND extern = 1"));
