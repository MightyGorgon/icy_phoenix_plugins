...
<div style="text-align: right;"><div class="post-buttons"><!-- BEGIN edit_button --><a href="{edit_button.U_EDIT}">{edit_button.EDIT_IMG}</a>&nbsp;<!-- END edit_button -->{U_DL_SEARCH}</div></div>
