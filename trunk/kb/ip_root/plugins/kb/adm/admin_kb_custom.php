...
{
	case 'addfield':
		$template_file = KB_ADM_TPL_PATH . 'kb_field_add.tpl';
		break;
	case 'editfield':
		$template_file = KB_ADM_TPL_PATH . 'kb_field_add.tpl';
		break;
	case 'edit':
		$template_file = KB_ADM_TPL_PATH . 'kb_select_field_edit.tpl';
		break;
	case 'add':
		$template_file = KB_ADM_TPL_PATH . 'kb_select_field_type.tpl';
		break;
	case 'delete':
		$template_file = KB_ADM_TPL_PATH . 'kb_select_field_delete.tpl';
		break;
	case 'select':
		$template_file = KB_ADM_TPL_PATH . 'kb_select.tpl';
		break;
}
