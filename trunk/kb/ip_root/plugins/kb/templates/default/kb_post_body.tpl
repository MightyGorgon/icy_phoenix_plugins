...
<!-- BEGIN switch_name -->
<tr>
	<td class="row1" width="22%"><span class="gen"><b>{L_NAME}</b></span></td>
...
<!-- END switch_name -->
<tr>
	<td class="row1" width="22%"><span class="gen"><b>{L_ARTICLE_TITLE}</b></span></td>
...
<tr>
	<td class="row1" valign="top"><span class="gen"><b>{L_ARTICLE_TYPE}</b></span></td>
...
<!-- END checkbox -->
<tr>
	<td class="row1" valign="top"><span class="gen"><b>{L_ARTICLE_TEXT}</b></span><br /><br />
