...
{IMG_THL}{IMG_THC}<span class="forumlink">{L_DL_FILES_TITLE}</span>{IMG_THR}<table class="forumlinenb">
...
<!-- END upload_traffic -->
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_NAME}:</span></td>
...
<!-- BEGIN cat_choose -->
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_CAT_NAME}:</span></td>
...
<!-- END cat_choose -->
<tr>
	<td class="row1 tw30pct" valign="top"><span class="gen">{L_DL_DESCRIPTION}:</span></td>
...
<tr>
	<td class="row1 tw30pct" valign="top"><span class="gen">{L_DL_UPLOAD_FILE}:</span></td>
	<td class="row1" width="2%" valign="top">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_UPLOAD_FILE_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_EXTERN}:</span></td>
...
<!-- BEGIN modcp -->
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_IS_FREE}:</span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_TRAFFIC}:</span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_APPROVE}:</span></td>
...
<!-- BEGIN change_time -->
<tr>
	<td class="row1 tw30pct"><span class="gen">{change_time.L_CHANGE_TIME}:</span></td>
...
<!-- BEGIN popup_notify -->
<tr>
	<td class="row1 tw30pct"><span class="gen">{popup_notify.L_DISABLE_POPUP}:</span></td>
...
<!-- BEGIN email_block -->
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_SEND_NOTIFY}:</span></td>
...
<!-- END email_block -->
<tr>
	<td class="cat tdalignc" colspan="3"><input type="submit" name="submit" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" class="liteoption" /></td>
</tr>
<!-- BEGIN use_hacklist -->
<!--
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_HACKLIST}:</span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_HACK_VERSION}:</span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_HACK_AUTHOR}:</span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_HACK_AUTHOR_EMAIL}:</span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_HACK_AUTHOR_WEBSITE}:</span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_HACK_DL_URL}:</span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_MOD_LIST}:</span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_MOD_TEST}:</span><br /></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen">{L_DL_MOD_REQUIRE}:</span></td>
...
<tr>
	<td class="row1 tw30pct" valign="top"><span class="gen">{L_DL_MOD_DESC}:</span><br /></td>
...
<tr>
	<td class="row1 tw30pct" valign="top"><span class="gen">{L_DL_MOD_WARNING}:</span><br /></td>
...
<tr>
	<td class="row1 tw30pct" valign="top"><span class="gen">{L_DL_MOD_TODO}:</span></td>
