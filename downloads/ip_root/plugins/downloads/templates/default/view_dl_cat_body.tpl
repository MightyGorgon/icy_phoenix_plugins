...
<!-- BEGIN downloads -->
<tr>
	<td class="{downloads.ROW_CLASS} row-center tw37px"><img src="{downloads.CAT_IMG}" alt="{downloads.CAT_NAME}" /></td>
...
<div style="text-align: right;"><div class="post-buttons">{U_DL_SEARCH}</div></div>
<br />
