...
<tr>
	<th class="tdnw">{L_DL_NAME}</th>
	<th class="tdnw">{L_EDIT}</th>
	<th class="tdnw">{L_DELETE}</th>
	<th class="tdnw" colspan="2">{L_ORDER}</th>
</tr>
<!-- BEGIN categories -->
<tr>
...
<table>
<tr>
	<td class="tdalignc"><a href="{U_DELETE_STATS_ALL}" class="nav">{L_DELETE_STATS_ALL}</a></td>
	<td class="tdalignc"><a href="{U_SORT_LEVEL_ZERO}" class="nav">{L_SORT_ASC_LEVEL_ZERO}</a></td>
	<td class="tdalignc"><a href="{U_DELETE_COMMENTS_ALL}" class="nav">{L_DELETE_COMMENTS_ALL}</a></td>
</tr>
</table>
</form>
