...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_PATH_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_USER_DOWNLOAD_LIMIT_FLAG_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_USER_DOWNLOAD_LIMIT_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_METHOD_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_METHOD_QUOTA_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_ICON_FREE_FOR_REG_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_NEW_TIME_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_EDIT_TIME_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_EDIT_OWN_DOWNLOADS_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_SHOW_FOOTER_LEGEND_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_SHOW_FOOTER_STATS_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_SHOW_REAL_FILETIME_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_SHORTEN_EXTERN_LINKS_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_LIMIT_DESC_ON_INDEX_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DOWNLOAD_VC_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_REPORT_BROKEN_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_REPORT_BROKEN_LOCK_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_REPORT_BROKEN_MESSAGE_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_REPORT_BROKEN_VC_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_LINKS_PER_PAGE_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_SORT_PREFORM_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_RECENT_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_LATEST_COMMENTS_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_POSTS_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_PHYSICAL_QUOTA_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
	<td class="row2" width="30%">
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_OVERALL_TRAFFIC_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
	<td class="row2" width="30%">
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_USER_TRAFFIC_ONCE_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_ENABLE_POST_TRAFFIC_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_NEWTOPIC_TRAFFIC_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_REPLY_TRAFFIC_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
	<td class="row2" width="30%">
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_DELAY_AUTO_TRAFFIC_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_DELAY_POST_TRAFFIC_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_STOP_UPLOADS_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_UPLOAD_TRAFFIC_COUNT_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_THUMBSNAIL_SIZE_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
	<td class="row2" width="30%">
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_THUMBSNAIL_DIM_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
	<td class="row2" width="30%">
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_DISABLE_EMAIL_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_DISABLE_POPUP_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_DISABLE_POPUP_NOTIFY_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_STATS_PERM_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
	<td class="row2" width="30%">{S_STATS_PERM_SELECT}</td>
</tr>
<tr>
	<td class="row1" width="68%"><strong>{L_DL_GUEST_STATS_SHOW}</strong></td>
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_GUEST_STATS_SHOW_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_PREVENT_HOTLINK_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_HOTLINK_ACTION_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
...
<tr>
	...
	<td class="row1" width="2%">&nbsp;[<a href="javascript:void(0)" onclick="help_popup('{L_DL_USE_HACKLIST_EXPLAIN}')" class="nav">?</a>]&nbsp;</td>
