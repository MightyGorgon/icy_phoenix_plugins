<table class="s5px tw100pct">
<tr>
	<td class="tvalignm tw50pct">
		...
		<tr>
			<td class="row1 tw25pct"><span class="genmed"><strong>{L_USERNAME}:</strong></span></td>
			<td class="row2" width="75%"><input type="text" class="post" name="username" size="20" maxlength="32" value="" /></td>
		</tr>
		<tr>
			<td class="row1 tw25pct"><span class="genmed"><strong>{L_TRAFFIC}:</strong></span></td>
		...
		<tr>
			<td class="row1 tw25pct"><span class="genmed"><strong>{L_FUNCTION}:</strong></span></td>
		...
		<table class="forumline">
		<tr><th colspan="2">{L_ALL_USERS_TITLE}</th></tr>
		<tr><td class="row3 row-center tw100pct" colspan="2"><span class="gensmall">{L_ALL_USERS_EXPLAIN}</span></td></tr>
		<tr>
			<td class="row1 tw25pct"><span class="genmed"><strong>{L_TRAFFIC}:</strong></span></td>
			<td class="row2" width="75%">
			<span class="genmed">
		...
		<tr>
			<td class="row1 tw25pct"><span class="genmed"><strong>{L_USERGROUP}:</strong></span></td>
	...
	<td class="tvalignm tw50pct">
		...
		<tr>
			<td class="row1 tw30pct"><span class="genmed"><strong>{L_USER_DL_AUTO_TRAFFIC}</strong></span></td>
			<td class="row2 tw70pct">
			<span class="genmed">
		...
		<!-- BEGIN group_row -->
		<tr>
			<td class="row1 tw30pct"><span class="genmed"><strong>{group_row.GROUP_NAME}</strong></span></td>
			<td class="row2 tw70pct">
			<span class="genmed">
