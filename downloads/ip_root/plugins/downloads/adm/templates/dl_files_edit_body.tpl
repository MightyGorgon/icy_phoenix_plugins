...
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_NAME}:</b></span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_CAT_NAME}:</b></span></td>
...
<tr>
	<td class="row1 tw30pct" valign="top"><span class="gen"><b>{L_DL_DESCRIPTION}:</b></span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_LINK_URL}:</b></span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_EXTERN}:</b></span></td>
...
<!-- BEGIN allow_thumbs -->
<tr>
	<td class="row1 tw30pct" valign="top"><span class="gen"><b>{L_DL_THUMBNAIL}:</b></span></td>
...
<!-- END allow_thumbs -->
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_IS_FREE}:</b></span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_TRAFFIC}:</b></span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_APPROVE}:</b></span></td>
...
<!-- BEGIN change_time -->
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{change_time.L_CHANGE_TIME}:</b></span></td>
...
<!-- BEGIN popup_notify -->
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{popup_notify.L_DISABLE_POPUP}:</b></span></td>
...
<!-- BEGIN email_block -->
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{email_block.L_DL_SEND_NOTIFY}:</b></span></td>
...
<!-- BEGIN use_hacklist -->
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_HACKLIST}:</b></span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_HACK_VERSION}:</b></span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_HACK_AUTHOR}:</b></span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_HACK_AUTHOR_EMAIL}:</b></span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_HACK_AUTHOR_WEBSITE}:</b></span><br /></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_HACK_DL_URL}:</b></span><br /></td>
...
<!-- BEGIN use_mod_desc -->
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_MOD_LIST}:</b></span></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_MOD_TEST}:</b></span><br /></td>
...
<tr>
	<td class="row1 tw30pct"><span class="gen"><b>{L_DL_MOD_REQUIRE}:</b></span></td>
...
<tr>
	<td class="row1 tw30pct" valign="top"><span class="gen"><b>{L_DL_MOD_DESC}:</b></span><br /></td>
...
<tr>
	<td class="row1 tw30pct" valign="top"><span class="gen"><b>{L_DL_MOD_WARNING}:</b></span><br /></td>
...
<tr>
	<td class="row1 tw30pct" valign="top"><span class="gen"><b>{L_DL_MOD_TODO}:</b></span></td>
