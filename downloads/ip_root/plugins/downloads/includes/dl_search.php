...
if ($search_keywords != '' && !$search_author)
{
	...
	$pagination = generate_pagination('downloads.' . PHP_EXT . '?view=search&search_keywords=' . $search_keywords . '&search_cat=' . $search_cat . '&sort_dir=' . $sort_dir, $total_found_dl, $config['topics_per_page'], $start);
...
elseif ($search_author)
{
	...
	$pagination = generate_pagination('downloads.' . PHP_EXT . '?view=search&search_author=' . $search_author . '&search_cat=' . $search_cat . '&sort_dir=' . $sort_dir, $total_found_dl, $config['topics_per_page'], $start);
