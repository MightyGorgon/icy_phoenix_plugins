...
if (empty($mode))
{
	...
	$template_to_parse = $class_plugins->get_tpl_file(ALBUM_TPL_PATH, 'album_modcp_body.tpl');
...
else
{
	...
	if ($mode == 'move')
	{
		...
		if(!isset($_POST['target']))
		{
			...
			$template_to_parse = $class_plugins->get_tpl_file(ALBUM_TPL_PATH, 'album_move_body.tpl');
			full_page_generation($template_to_parse, $lang['Album'], '', '');
		}
		else
		{
	...
	elseif ($mode == 'copy')
	{
		...
		if(!isset($_POST['target']))
		{
			...
			$template_to_parse = $class_plugins->get_tpl_file(ALBUM_TPL_PATH, 'album_copy_body.tpl');
			full_page_generation($template_to_parse, $lang['Album'], '', '');
		}
		else
		{
