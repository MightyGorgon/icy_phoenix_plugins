...
$cms_page['page_id'] = 'album_personal_cat_admin';
...
setup_extra_lang(array('lang_admin'));
setup_extra_lang(array('lang_admin'), ALBUM_ROOT_PATH . 'language/');
...
if(!isset($_POST['mode']))
{
	if(!isset($_GET['action']))
	{
		...
		$template_to_parse = $class_plugins->get_tpl_file(ALBUM_TPL_PATH, 'album_personal_cat_body.tpl');
		full_page_generation($template_to_parse, $lang['Album'], '', '');
	}
	else
	{
		...
		elseif($_GET['action'] == 'edit')
		{
			...
			$template_to_parse = $class_plugins->get_tpl_file(ALBUM_TPL_PATH, 'album_personal_cat_new_body.tpl');
			full_page_generation($template_to_parse, $lang['Album'], '', '');
		}
		elseif($_GET['action'] == 'delete')
		{
			...
			$template_to_parse = $class_plugins->get_tpl_file(ALBUM_TPL_PATH, 'album_personal_cat_delete_body.tpl');
			full_page_generation($template_to_parse, $lang['Album'], '', '');
		}
