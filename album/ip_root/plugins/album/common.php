...
{
	include_once(ALBUM_ROOT_PATH . 'constants.' . PHP_EXT);
}
...
$GLOBALS['album_debug_enabled'] = ($album_config['album_debug_mode'] == 1) ? true : false;
$thumb_size = ($album_config['show_img_no_gd'] == 1) ? ('width="' . $album_config['thumbnail_size'] . '"') : '';
