...
<tr>
	...
	<div class="buttons">
		...
		<div class="managepics-button"><a href="{U_MANAGE_PIC}"><span>{L_MANAGE_PIC}</span></a></div>
		<!-- END manage_personal_gal_folders -->
		<!-- BEGIN enable_view_toggle -->
		<div class="showall-button"><a href="{U_TOGGLE_VIEW_ALL}"><span>{L_TOGGLE_VIEW_ALL}</span></a></div>
