...
if (!empty($setmodules))
{
	...
	$module['3200_ACTIVITY']['170_Char_Settings'] = $file;
	return;
}
...
if (!$mode)
{
	...
	echo '	</tr>';
	echo '	<tr>';
	echo '		<td class="tdalignl row1">';
	echo 			$lang['amp_char_change_char'];
	echo '		</td>';
	echo '		<td class="tdalignl row2">';
	echo '			<input type="text" class="post" value="'. $config['ina_char_change_char_cost'] .'" name="char_img" size="10">';
	echo '		</td>';
	echo '	</tr>';
	echo '	<tr>';
	echo '		<td class="tdalignl row1">';
	...
	echo '		</td>';
	echo '		<td class="tdalignl row2">';
	echo '			<input type="text" class="post" value="'. $config['ina_char_change_name_cost'] .'" name="char_name" size="10">';
	echo '		</td>';
	echo '	</tr>';
	echo '	<tr>';
	echo '		<td class="tdalignl row1">';
	...
	echo '		</td>';
	echo '		<td class="tdalignl row2">';
	echo '			<input type="text" class="post" value="'. $config['ina_char_change_title_cost'] .'" name="char_title" size="10">';
	echo '		</td>';
	echo '	</tr>';
	echo '	<tr>';
	echo '		<td class="tdalignl row1">';
	...
	echo '		</td>';
	echo '		<td class="tdalignl row2">';
	echo '			<input type="text" class="post" value="'. $config['ina_char_change_saying_cost'] .'" name="char_saying" size="10">';
	echo '		</td>';
	echo '	</tr>';
	echo '	<tr>';
	echo '		<td class="tdalignl row1">';
	...
	echo '		</td>';
	echo '		<td class="tdalignl row2">';
	echo '			<input type="text" class="post" value="'. $config['ina_char_change_gender_cost'] .'" name="char_gender" size="10">';
	echo '		</td>';
	echo '	</tr>';
	echo '	<tr>';
	echo '		<td class="tdalignl row1">';
	...
	echo '		</td>';
	echo '		<td class="tdalignl row2">';
	echo '			<input type="text" class="post" value="'. $config['ina_char_change_from_cost'] .'" name="char_from" size="10">';
	echo '		</td>';
	echo '	</tr>';
	echo '	<tr>';
	echo '		<td class="tdalignl row1">';
	...
	echo '		</td>';
	echo '		<td class="tdalignl row2">';
	echo '			<input type="text" class="post" value="'. $config['ina_char_change_intrests_cost'] .'" name="char_intrests" size="10">';
	echo '		</td>';
	echo '	</tr>';
	echo '	<tr>';
	echo '		<td class="tdalignl row1">';
	...
	echo '		</td>';
	echo '		<td class="tdalignl row2">';
	echo '			<input type="text" class="post" value="'. $config['ina_char_change_age_cost'] .'" name="char_age" size="10">';
	echo '		</td>';
	echo '	</tr>';
	echo '	<tr>';
	echo '		<th width="80%">';
	...
	$char_name_costs = explode(',', $config['ina_char_name_effects_costs']);
	$char_title_costs = explode(',', $config['ina_char_title_effects_costs']);
	$char_saying_costs = explode(',', $config['ina_char_saying_effects_costs']);
	echo '	<tr>';
	echo '		<td class="tdalignl row1">';
	...
	echo '		<th width="20%">&nbsp;</th>';
	echo '	</tr>';
	$viewtopic = (($config['ina_char_show_viewtopic'] == 1) ? 'checked="on"' : '');
	echo '	<tr>';
	echo '		<td class="tdalignl row1">';
	...
	echo '		</td>';
	echo '	</tr>';
	$viewprofile = (($config['ina_char_show_viewprofile'] == 1) ? 'checked="on"' : '');
	echo '	<tr>';
	echo '		<td class="tdalignl row1">';
	...
	echo '	</tr>';
	echo '	<tr>';
	echo '		<td class="row2 tdalignc tw100pct" colspan="2">';
	...
	echo '		</td>';
	echo '		<td class="tdalignl row2">';
	echo '			<input type="text" class="post" value="'. $config['ina_char_ge_per_game'] .'" name="per_game" size="10">';
	echo '		</td>';
	echo '	</tr>';
	echo '	<tr>';
	echo '		<td class="tdalignl row1">';
	...
	echo '		</td>';
	echo '		<td class="tdalignl row2">';
	echo '			<input type="text" class="post" value="'. $config['ina_char_ge_per_beat_score'] .'" name="per_score" size="10">';
	echo '		</td>';
	echo '	</tr>';
	echo '	<tr>';
	echo '		<td class="tdalignl row1">';
	...
	echo '		</td>';
	echo '		<td class="tdalignl row2">';
	echo '			<input type="text" class="post" value="'. $config['ina_char_ge_per_trophy'] .'" name="per_trophy" size="10">';
	echo '		</td>';
	echo '	</tr>';
	echo '	<tr>';
	echo '		<th colspan="2">';
