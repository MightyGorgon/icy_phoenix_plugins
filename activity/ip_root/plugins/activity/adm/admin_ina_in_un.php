...
if (!empty($setmodules))
{
	...
	$module['3200_ACTIVITY']['105_DB_Adjustments'] = $file;
	return;
}
...
{
	echo "<table class=\"forumline\" width=\"100%\" cellspacing=\"0\" border=\"0\">";
	echo "<tr><td class=\"row2\"><span class='gensmall'>" . $lang['admin_db_2'] . "</span></td></tr>";
	echo "</table>";
	echo "<br /><br />";
	echo "<table class=\"forumline\" width=\"100%\" cellspacing=\"0\" border=\"0\">";
	echo "<tr><td class=\"row2 row-center\" width=\"100%\" valign=\"top\"><span class=\"genmed\">" . $lang['admin_db_3'] . "</span></td></tr>";
	echo "</table>";
	echo "<br /><br />";
	...
	echo "<br /><br />";
	echo "<table class=\"forumline\" width=\"100%\" cellspacing=\"0\" border=\"0\">";
	echo "<tr><td class=\"row2 row-center\" width=\"100%\" valign=\"top\"><span class=\"genmed\">" . $lang['admin_db_5'] . "</span></td></tr>";
	echo "</table>";
	...
	echo "<br /><br />";
	echo "<table class=\"forumline\" width=\"100%\" cellspacing=\"0\" border=\"0\">";
	echo "<tr><td class=\"row2 row-center\" width=\"100%\" valign=\"top\"><span class=\"genmed\">" . $lang['admin_db_13'] . "</span></td></tr>";
	echo "</table>";
	echo "<br /><br />";
