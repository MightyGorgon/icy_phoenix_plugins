...
<tr>
	...
	<th width="18%" align="center">{main_cats.TITLE_3}</th>
	<th width="13%" align="center">{main_cats.TITLE_4}</th>
	<th width="13%"  align="center">{main_cats.TITLE_5}</th>
	<th width="13%"  align="center">{main_cats.TITLE_6}</th>
</tr>
<tr>
	...
	<td class="row1 row-center"><span class="genmed">{main_cats.P_GAMES}</span></td>
</tr>
<!-- END main_cats -->
...
<tr>
	...
	<td class="row1 row-center"><span class="genmed">{main_cats_rows.SIX}</span></td>
</tr>
<!-- END main_cats_rows -->
<!-- BEGIN main_cats -->
