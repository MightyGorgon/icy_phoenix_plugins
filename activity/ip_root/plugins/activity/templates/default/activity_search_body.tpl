...
{IMG_THL}{IMG_THC}<span class="forumlink">{SEARCH_TITLE}</span>{IMG_THR}<table class="forumlinenb">
<tr>
...
{IMG_THL}{IMG_THC}<span class="forumlink">{L_admin_cat_24}</span>{IMG_THR}<table class="forumlinenb">
<!-- BEGIN search_results -->
<tr>
	<th class="tw20pct">{L_IMAGE}</th>
	<th class="tw30pct">{L_NAME}</th>
