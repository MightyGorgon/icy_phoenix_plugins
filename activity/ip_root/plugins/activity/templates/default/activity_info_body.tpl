...
<div id="info_games_h" style="display: none;">
	{IMG_THL}{IMG_THC}<img class="max-min-right" style="padding-top: 3px;" src="{IMG_MAXIMISE}" onclick="ShowHide('info_games','info_games_h','info_games');" alt="{L_SHOW}" /><span class="forumlink">{info_box.L_INFO_TITLE}</span>{IMG_THR}<table class="forumlinenb">
	<tr><td class="row1g row-center">&nbsp;</td></tr>
	</table>{IMG_TFL}{IMG_TFC}{IMG_TFR}
</div>
<div id="info_games">
	{IMG_THL}{IMG_THC}<img class="max-min-right" style="padding-top: 3px;" src="{IMG_MINIMISE}" onclick="ShowHide('info_games','info_games_h','info_games');" alt="{L_HIDE}" /><span class="forumlink">{info_box.L_INFO_TITLE}</span>{IMG_THR}<table class="forumlinenb">
<tr>
